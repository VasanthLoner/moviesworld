      ...
      <div className="left">
        ...
        <p>
          ...
          <p>
            ...
            platform are trademarks of, and all <br /> related images and
            content are the property of, Streamit Inc. Duplication and copy of
            this is strictly <br /> prohibited. All rights reserved.
          </p>
        </p>
      </div>
      <div className="right">
        ...
        <div className="divfacebook">
          {" "}
          <img className="googleplus" src={Googleplus} alt="facebook" />
        </div>
        <div className="divfacebook">
          <img className="github" src={Github} alt="facebook" />
        </div>
      </div>
      <div className="cener">
        <h2>Streamit App</h2>
        <div className="divfacebook1">
          {" "}
          <img className="playstore" src={Playstore} alt="facebook" />
        </div>
        <div className="divfacebook1">
          <img className="applestore" src={Applestore} alt="facebook" />
        </div>
      </div>
    </div>
  );
